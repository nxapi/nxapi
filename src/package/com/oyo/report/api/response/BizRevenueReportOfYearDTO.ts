...
export interface IBizRevenueReportOfYearDTO {
  bizDate?: Date;
...
export class BizRevenueReportOfYearDTO {
  constructor(params: IBizRevenueReportOfYearDTO) {
  ...
  __fields2java(): any {
    return {
      $class: 'com.oyo.report.api.response.BizRevenueReportOfYearDTO',
      $: {

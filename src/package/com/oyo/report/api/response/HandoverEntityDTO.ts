...
export interface IHandoverEntityDTO {
...
export class HandoverEntityDTO {
  constructor(params: IHandoverEntityDTO) {
  ...
  __fields2java(): any {
    return {
      $class: 'com.oyo.report.api.response.HandoverEntityDTO',
      $: {

import { BizRevenueReportOfYearDTO } from './BizRevenueReportOfYearDTO';
import java from 'js-to-java';

export interface IBizRevenueReportYearDTO {
  totalRoomNights?: {value: string};
  totalAvgRoomPrice?: {value: string};
  revenueReportList?: Array<BizRevenueReportOfYearDTO>;
  totalPages?: number;
  pageSize?: number;
  totalCount?: number;
  pageNum?: number;
...
export class BizRevenueReportYearDTO {
  constructor(params: IBizRevenueReportYearDTO) {
  ...
  __fields2java(): any {
    return {
      $class: 'com.oyo.report.api.response.BizRevenueReportYearDTO',
      $: {
